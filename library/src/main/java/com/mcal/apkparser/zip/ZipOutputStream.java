...
public class ZipOutputStream extends FilterOutputStream {
    ...
    public void setEncoding(final String encoding) {
        ...
        this.zipEncoding = isUTF8 ? ZipEncodingHelper.UTF8_ZIP_ENCODING : ZipEncodingHelper.getZipEncoding(encoding);
...
//    private static final byte[] DOS_TIME_MIN = ZipLong.getBytes(0x00002100L);
    ...
    protected void writeCentralFileHeader(@NotNull ZipEntry ze) throws IOException {
        ...
        // version made by
        // CheckStyle:MagicNumber OFF
        ZipShort.putShort((ze.getPlatform() << 8) | 20, data, 4);
        written += SHORT;
...
//        putBytes(ZERO, buf, 4);
//        putBytes(ZERO, buf, 6);
        ZipShort.putShort(entries.size(), buf, 8);
        ZipShort.putShort(entries.size(), buf, 10);
...
//        writeOut(data.array(), data.arrayOffset(), data.limit());
    ...
    private void writeVersionNeededToExtractAndGeneralPurposeBits(
        ...
        ZipShort.putShort(generalPurposeFlag, data, offset + SHORT);
    }
