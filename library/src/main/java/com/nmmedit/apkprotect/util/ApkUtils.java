...
public final class ApkUtils {
     ...
     */
    public static byte @Nullable [] getFile(File apkFile, String filename) throws IOException {
    ...
    private static byte @NotNull [] toByteArray(@NotNull InputStream in) throws IOException {
    ...
    public static @NotNull List<File> extractFiles(File apkFile, String regex, File outDir) throws IOException {
        return extractFiles(apkFile, Pattern.compile(regex), outDir);
    }

    public static @NotNull List<File> extractFiles(File apkFile, Pattern regex, File outDir) throws IOException {
        try (ZipArchive apkZip = new ZipArchive(apkFile.toPath())) {
