...
public class BuildNativeLib {
    ...
    public BuildNativeLib(ApkLogger apkLogger) {
        this.apkLogger = apkLogger;
    }

    //编译出native lib，同时返回最后的so文件
    public List<File> build(@NotNull CMakeOptions options) throws IOException {
    ...
    private void execCmd(List<String> cmds) throws IOException {
